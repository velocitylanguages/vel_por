...
def generate_video_metadata(category: str, num_phrases: int):
    """Generate Portuguese title, description, and tags for the video"""

    title = f"Aprenda Português: {num_phrases} Frases Essenciais de {category} 🇵🇹"

    description = f"""Aprenda {num_phrases} frases essenciais em português para {category}!

Perfeito para iniciantes que estão aprendendo português. Cada frase inclui:
✅ Frase em inglês
✅ Tradução em português
✅ Guia de pronúncia
✅ Contexto de uso

Inscreva-se para aulas diárias de português!

#AprendaPortugues #PortuguesParaIniciantes #Portugues #EnsinoDePortugues
#Portugues #Educacao #Tutorial #PortuguesDiario #{category.replace(' ', '')}
"""

    tags = [
        "aprenda portugues",
        "aulas de portugues",
        "portugues para iniciantes",
        "frases em portugues",
        "aprender idiomas",
        "portugues tutorial",
        "falar portugues",
...
def main():
    ...
    # Generate Portuguese metadata for test
    title = "Aprenda Português: 5 Frases Essenciais de Motivação 🇵🇹"
    description = "Aprenda 5 frases essenciais em português para Motivação! #AprendaPortugues #PortuguesParaIniciantes"
    tags = ['aprenda portugues', 'portuguese lessons', 'motivacao']
